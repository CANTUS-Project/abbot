...
$handler->display->display_options['style_options']['filename'] = 'list_of_centuries.xml';
$handler->display->display_options['style_options']['parent_sort'] = 0;
$handler->display->display_options['style_options']['transform'] = 1;
$handler->display->display_options['style_options']['transform_type'] = 'underline';
$handler->display->display_options['style_options']['root_node'] = 'centuries';
$handler->display->display_options['style_options']['item_node'] = 'century';
$handler->display->display_options['path'] = 'export-centuries';
