$view = new view();
$view->name = 'abbot_export_segments';
$view->description = '';
$view->tag = 'default';
$view->base_table = 'taxonomy_term_data';
$view->human_name = 'Abbott: Export Segments';
$view->core = 7;
...
$handler->display->display_options['style_options']['filename'] = 'list_of_segments.xml';
$handler->display->display_options['style_options']['parent_sort'] = 0;
$handler->display->display_options['style_options']['transform'] = 1;
$handler->display->display_options['style_options']['transform_type'] = 'underline';
$handler->display->display_options['style_options']['root_node'] = 'segments';
$handler->display->display_options['style_options']['item_node'] = 'segment';
$handler->display->display_options['path'] = 'export-segments';
