...
$handler->display->display_options['style_options']['filename'] = 'list_of_source_statii.xml';
$handler->display->display_options['style_options']['parent_sort'] = 0;
$handler->display->display_options['style_options']['transform'] = 1;
$handler->display->display_options['style_options']['transform_type'] = 'underline';
$handler->display->display_options['style_options']['root_node'] = 'source_statii';
$handler->display->display_options['style_options']['item_node'] = 'source_status';
$handler->display->display_options['path'] = 'export-source-statii';
